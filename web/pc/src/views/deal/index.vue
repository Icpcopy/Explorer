        ...
        <el-table-column prop="address" label="From" width="150" align="center">
          <template #default="scope">
            ...
            <div v-else>
              <div
                v-if="
                  scope.row.event[0].fromIsNull == 0 &&
                  !scope.row.event[0].from == false
                "
              >
                <el-tooltip
                  class="item"
              ...
              <div v-if="!scope.row.event[0].from == true">--</div>
        ...
        <el-table-column prop="address" label="To" width="150" align="center">
          <template #default="scope">
            ...
            <div v-else>
              ...
              <div
                v-if="
                  !scope.row.event[0].to == true &&
                  scope.row.event[0].toIsNull !== 1 &&
                  scope.row.event[0].toIsNull !== 2
                "
              >
                --
              </div>
...
export default {
  ...
  created() {
    var pages = JSON.parse(sessionStorage.getItem("dealIndex"));
    if (pages != null) {
  ...
  methods: {
    srechclickFn(val) {
      ...
      this.pageIndex = 1;
      sessionStorage.setItem("dealIndex", 1);
    ...
    currpageChange(val) {
      this.pageIndex = val;
      sessionStorage.setItem("dealIndex", val);
      this.getByBlockNumberFn();
    },
