<template>
  <div class="icp-repeatTxs">
    <div class="icp-repeatTxs__tip">
      <div class="icp-repeatTxs__tip--text">
        ICT-721 Txs List {{ total || 0 }} Txs
      </div>
      <div class="icp-repeatTxs__tip--search">
    ...
    <div class="icp-repeatTxs__table">
      <el-table
        v-loading="loading"
        ref="multipleTable"
        :data="tableData"
        tooltip-effect="dark"
        stripe
        header-cell-class-name="icp-repeatTxs__table--header"
      >
        <el-table-column
          align="center"
        ...
        >
          <template #default="{ row }">
            ...
            <span v-if="item.prop == 'tokenInfo'">
              ...
              >
                <!-- <img src="" />{{ row["symbol"] || "--" }} -->
                <div class="icp-repeatTxs__table--tokenInfo">
                  <div class="ittt-img">
                    <img
                      v-if="row['tokenLogo']"
                      :src="row['tokenLogo'] || ''"
