      ...
      <div class="left">
        ...
        <div class="tables">
          ...
          >
            ...
            <el-table-column :label="`Amount(${coinName})`" width="180">
              <template #default="scope">
                {{
                  (scope.row.balance.amount &&
                    onFeixedNum(
                      (scope.row.balance.amount / 10000000000000000000) * 10,
                      6
                    )) ||
                  0
                }}
            ...
            <el-table-column label="Shares">
              <template #default="scope">
                {{
                  scope.row.delegation.shares &&
                  onFeixedNum(scope.row.delegation.shares, 2)
                }}
              </template>
            </el-table-column>
          </el-table>
      ...
      <div class="right">
        ...
        <div class="tables">
          ...
          >
            ...
            <el-table-column
              prop="name"
              :label="`Amount(${coinName})`"
              width="180"
            >
              <template #default="scope">
                {{
                  (scope.row.countAounmnt &&
                    onFeixedNum(
                      (scope.row.countAounmnt / 10000000000000000000) * 10,
                      6
                    )) ||
                  0
                }}
