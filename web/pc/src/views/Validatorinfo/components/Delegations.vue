<template>
  <div class="container">
    <div class="left">
      ...
      <div class="echarts_left">Bonded Token({{ userInfoData.coinName }})</div>
    ...
    <div class="right">
      <ul>
        ...
        <li>
          ...
          <span class="huise">
            {{
              (userInfoData.tokens &&
                onFeixedNum(
                  (userInfoData.tokens / 10000000000000000000) * 10,
                  6
                )) ||
              0
            }}
            ...
            <div>
              ...
              {{
                (userInfoData.selfDelegateAmount &&
                  onFeixedNum(userInfoData.selfDelegateAmount, 6)) ||
                0
              }}
              {{ coinName }}
            </div>
        ...
        <li>
          ...
          <span class="huise">
            {{
              userInfoData.delegator_shares &&
              onFeixedNum(userInfoData.delegator_shares, 2)
            }}
          </span>
        </li>
        <li>
...
export default {
  mixins: [mixinCommon],
  props: ["userInfoData", "datas", "coinName"],
  data() {
    return {};
  },
  mounted() {},
