<template>
  <div class="headers">
    <div class="container">
      <!-- <div
        class="left cursor_"
        v-if="iSsrcBool == 'gauss'"
        @click="headerRouterFn('/index')"
      >
        <div>
      ...
      <div
        v-else-if="iSsrcBool == 'themis'"
        class="left cursor_"
        @click="headerRouterFn('/index')"
      >
        <div>
          <img class="log" src="../../assets/themis.png" alt />
        </div>
        <div>
          <img
            class="log_usdg_txt"
            width="200px"
            src="../../assets/themistext.png"
            alt
          />
        </div>
      </div>
      ...
      >
        ...
        <div>
          <img
            class="log_usdg_txt"
            width="200px"
            src="../../assets/gpb_text.png"
            alt
          />
        </div>
      </div> -->

      <div class="left cursor_" @click="headerRouterFn('/index')">
        <div>
          <img class="log" src="../../assets/icplazaLogo.png" alt />
        </div>
        <!-- <span>ICPlaza</span> -->
        <div>
          <span
          ...
          <!-- <img class="log_txt" src="../../assets/logo_title.png" alt /> -->
        </div>
      </div>
      <div class="right">
          ...
          <div class="left-text">
            ...
            <div>
              <div class="movebox routes_select">
                ...
                <ul class="Staking childrenbox">
                  <li @click="headerRouterFn('/tokens/index')">ICT20 Tokens</li>
                  <li @click="headerRouterFn('/tokens/txs')">ICT20 Txs</li>
                  <li @click="headerRouterFn('/tokens/repeat-list')">
                    ICT721 Tokens
                  </li>
                  <li @click="headerRouterFn('/tokens/repeat-txs')">
                    ICT721 Txs
                  </li>
                </ul>
              </div>
            ...
            <div>
              <div class="movebox routes_select">
                ...
                <ul class="Staking childrenbox">
                  <li @click="headerRouterFn('/nft/index')">NFT</li>
                  <li @click="headerRouterFn('/nft/stats')">NFT Stats</li>
                </ul>
              </div>
            </div>
            <div
            ...
            <div>
              <div class="movebox routes_select">
                ...
                <ul class="Staking childrenbox">
                  ...
                  <li @click="headerRouterFn('/Sendtherecord')">
                    Delegation Txs
                  </li>
                  <li @click="headerRouterFn('/Verifierverification')">
                    Validation Txs
                  </li>
                </ul>
              </div>
            ...
            <div>
              <div class="movebox routes_select">
                ...
                <ul class="childrenbox">
                  <li
                    class="cursor_"
                    @click="headerRouterFn('/Governanceproposals')"
                  >
                    Proposals
                  </li>
                  <li
                    class="cursor_"
                    @click="headerRouterFn('/Proposedtransaction')"
                  >
                    Gov Txs
                  </li>
                </ul>
            ...
            <div>
              <div class="movebox routes_select">
                ...
                <ul class="Stats childrenbox">
                  <li class="cursor_" @click="headerRouterFn('/statistics')">
                    {{ coinName }} Rich List
                  </li>
                  <li class="cursor_" @click="headerRouterFn('/statistical')">
                    {{ coinName }} Stats
                  </li>
                </ul>
              </div>
            </div>
            <div class="divs_ cursor_ margin_right routes_select">
              <a
          ...
          <!-- <div class="right-img-box">
            <div class="img-box-content">
              <div class="div-select-text cursor_">
                ...
                <span v-if="iSsrcBool == 'themis'">
                  <img
                    ...
                    style="margin-right:5px"
                  />
                  <span class="span_bizhong">THEMIS</span>
                </span>
              ...
              <ul class="select-bizhong">
                ...
                <li class="cursor_ lis" @click="routerIpFn('themis')">
  ...
  methods: {
    clickselectHeaderFn(path, isCreated) {
      ...
      setTimeout(() => {
        ...
        if (path.includes("tokens") && !path.includes("addressdetail")) {
          console.log(
            routes_select[1].childNodes[0],
            " routes_select[1].childNodes[0]==="
          );
          routes_select[1].childNodes[0].childNodes[0].style.color = "#5026EF";
        }
        if (path.includes("nft")) {
          routes_select[2].childNodes[0].childNodes[0].style.color = "#5026EF";
        }
        if (path == "/deal") {
          routes_select[3].style.color = "#5026EF";
        }
        ...
        if (path == "/Governanceproposals" || path == "/Proposedtransaction") {
          routes_select[5].childNodes[0].childNodes[0].style.color = "#5026EF";
        }

        if (path == "/statistics" || path == "/statistical") {
          routes_select[6].childNodes[0].childNodes[0].style.color = "#5026EF";
        }
      });
    },
    ...
    getChainNameFn() {
      getChainName().then((res) => {
        ...
        var urlTxt = "";
        this.coinName = (res.coinName && res.coinName.toUpperCase()) || "";
    ...
    routerIpFn(val) {
      switch (val) {
        ...
        case "fec":
          ...
          break;
        case "themis":
          window.location.href = this.http_name_data.themisUrl;
          break;
        // case "icplaza":
        //   window.location.href = this.http_name_data.icplazaUrl;
        //   break;
        case "gpb":
    ...
    headerRouterFn(roter_path) {
      ...
      sessionStorage.setItem("ProposedtransactionIndex", null);
      sessionStorage.setItem("SendtherecordIndex", null);
      sessionStorage.setItem("dealIndex", null);
      sessionStorage.setItem("VerifierverificationIndex", null);
      sessionStorage.setItem("bigtype", null);
