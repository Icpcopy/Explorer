<template>
  <div class="container">
    <div class="pages-zujian">
      <button type="button" class="frist shubiao" @click="handleSizeChange('frist')">First</button>
      <button type="button" class="left_button noclick">
        <i class="el-icon-arrow-left shubiao" @click="handleSizeChange('subtract')"></i>
      </button>
      ...
      <button type="button">
        <i class="right_button el-icon-arrow-right shubiao" @click="handleSizeChange('add')"></i>
      </button>

      <button type="button" class="last shubiao" @click="handleSizeChange('last')">Last</button>
    </div>
    <!-- <el-pagination
      background
