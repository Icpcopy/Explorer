...
//            }
//        }
//        System.out.println( getBalanceByCoin("gauss16qz2vqw6ze3ngyhdcuaghhkdfq4jcnvc0rqed0"),6);
...
//        query=1&prove=true&page=1&per_page=30&order_by=desc
    ...
    public static BigDecimal getBalanceByCoin(String address,int decimal){
        String uri=url+"/gauss/bank/v1beta1/balances/"+address+"/ugauss";
        String res=HttpUtils.httpGet(uri);
        JSONObject balance=JSON.parseObject(res);
        return balance.getJSONObject("balance").getBigDecimal("amount").divide(new BigDecimal(Math.pow(10,decimal))).setScale(decimal);
    }
