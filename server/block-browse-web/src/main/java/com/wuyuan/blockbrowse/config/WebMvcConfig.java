...
public class WebMvcConfig implements WebMvcConfigurer {
    ...
    @Bean
    public EVMosService getEvmosService(){
        String url=configService.getConfig("web3jUrl");
        EVMosService evMosService=new EVMosService(url);
        ConfigUtil.ChainDecimal=configService.getChaindecimal();
        CosmosUtil.decimal=configService.getChaindecimal();
        return evMosService;
    }
}