...
//    private String chainPrefix;
    ...
    public UpdateResult updateValidator(String operatorAddress, JSONObject validator){
        ...
        update.set("selfDelegateAddress",validator.getString("selfDelegateAddress"));
    ...
    public JSONObject getValidatorsByOperator(String operatorAddress){
        ...
        validator.put("coinName",configService.getCoinName1());
        //佣金收益
        BigDecimal commissionRewards =BalanceUtil.getValidateatorReward(operatorAddress,configService.getConfig(ConfigUtil.chainUrlKey)+"/"+configService.getChainPrefix(),chainName,configService.getChaindecimal());
