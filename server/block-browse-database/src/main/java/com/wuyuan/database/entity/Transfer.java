...
public class Transfer {
    ...
    public static final String SendToEth = "/gravity.v1.MsgSendToEthereum";

    public static final String WithdrawClaim = "/gravity.v1.MsgWithdrawClaim";

    public static final String SubmitEthereumEvent = "/gravity.v1.MsgSubmitEthereumEvent";

    public static final String SubmitEthereumTxConfirmation = "/gravity.v1.MsgSubmitEthereumTxConfirmation";
